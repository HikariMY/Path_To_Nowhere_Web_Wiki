...
-- ------------------------------------------------------------
-- CHARACTER GUIDES (ไกด์โดยผู้เล่น)
-- ------------------------------------------------------------
...
create index idx_character_guides_char
  on public.character_guides(character_id, upvotes desc, created_at desc);

create index idx_character_guides_author
...
-- GUIDE VOTES
-- ------------------------------------------------------------
create table public.character_guide_votes (
  id         uuid primary key default uuid_generate_v4(),
